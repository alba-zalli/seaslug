extends Node2D
# ONLY SPAWNS FISH IN INTRO SCREEN
...
func can_spawn_food() -> bool:
	...
	print("CURRENT FOOD COUNT: ", food_items.size())

	return food_items.size() < MAX_FOOD_ITEMS
...
func food_maker(food):
	...
	# Add it to the food tracking group
...
func spawn_algae():
	...
	var algae = alg_scene.instantiate()
